...
attachmentscanner-no-orphan-with-abs-1 = 附件根目录中没有多余文件, 但其中 1 个文件没有使用相对路径。
attachmentscanner-no-orphan-with-abs-n = 附件根目录中没有多余文件, 但其中 {$abs} 个文件没有使用相对路径。
attachmentscanner-abs-warning-1 = !!! 附件根目录中有 1 个文件没有使用相对路径，它可能被误认为多余文件.
attachmentscanner-abs-warning-n = !!! 附件根目录中有 {$abs} 个文件没有使用相对路径，它们可能被误认为多余文件.
...
attachmentscanner-enable-size-column =
    .label = 启用 “附件大小” 栏
